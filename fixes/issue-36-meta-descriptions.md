...
|---|---:|---|---|---:|---|
| Homepage | `3930` / `/` | Standard meta was generic and 246 chars on 2026-05-21; June 17 Search Console/GA4 review still flagged homepage title/description length as low-hanging. | Kris Krüg is an AI keynote speaker and creative technologist building community-first tools, talks, training, and media across BC+AI and Both Hands Full. | 153 | Matches the prepared homepage value in `page-meta.json`; deploy when homepage meta is refreshed. |
