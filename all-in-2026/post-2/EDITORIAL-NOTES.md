...
Fresh Plaud transaction readback completed for four recordings. Plaud tool IDs require the `of_` prefix; the bare hashes in the source package returned 404. Full transcripts were handled in tool memory and were not saved in the public repo. Timestamps below are elapsed recording time, not wall-clock time.

| Source | Selected evidence |
|---|---|
| `of_b0ba17236a754cfbf14622d3824b4ff8` (194 segments) | Angelica, 24:42 simulator explanation; 25:13 Pepper and complexity; 26:08 mirror question; 27:06 “janky simulators”; 32:21 research aim; 33:05 Human Line discussion; 36:58 KK's own Midjourney/sleep recollection. |
| `of_c64e64cb5a03a24f473c20cd391c1725` (191 segments) | 12:06 KK confirms David, Julie, Arjun; 38:58 KK's own dictation confirms disagreement with David about Web Summit value; 81–86 minutes Cordata's two products, civic documents, multilingual access and phone service. Uncertain speaker labels are not treated as identity proof. Cordata material is attributed to the crew, with no invented surname. |
| `of_97a2a37403313f8050192720ec7bc621` (212 segments) | Jeff, 12:43 local models; 12:58 device compute; 18:13 music; 40:00 Firebase shorthand; 50:41 and 51:40 recording consent/local transcription; 58:41 hydropower qualification; 70:57 language activism; 75:17 notecard line. Private financial discussion excluded entirely from draft, preview and this evidence note. |
| `of_3d36785ccb56ef29f052959e6f9f2c81` (181 segments) | Hanna, 26:59 Venture Track; 29:39 evening events; 34:36 West Coast interest; 55:42 sales-heavy conference experience; 57:28 value of drawing people to Vancouver. Her critique and positive qualification are both retained. |

Short quoted phrases were checked against the raw machine transcript and punctuation normalized. Longer or ambiguous speech is paraphrased. No claim of audio-level verification. The mirror quotation uses the exact words with sentence capitalization; “janky simulators,” the research-aim phrase, the Firebase shorthand, the Ojibwe phrase and the notecard line all occur in the source. These are user-provided recordings, not quotes copied from media coverage.

## Public source readback

- [SFU faculty profile](https://www.sfu.ca/fas/computing/people/faculty/faculty-members/angelica-lim.html), [Rosie Lab](https://www.rosielab.ca/) and [Human Line Project](https://thehumanlineproject.org/). Medical material stays an attributed interview account and research question; no diagnosis or causal result is asserted.
- [Jeff Ward / Animikii](https://animikii.com/about/jeff-ward): founded 2003, Ojibwe/Métis, Victoria/Lekwungen. [Niiwin](https://niiwin.app/): data design, governance, access and hosting choice. Technical and public biography claims grounded in these primary pages, with the local-compute forecast attributed to Jeff.
- [Hanna Demoz](https://www.amii.ca/people/hanna-demoz), [Amii literacy initiative](https://www.amii.ca/updates-insights/amii-leads-national-ai-literacy-initiative). The million-learner aim is supported; no unsupported $13M detail added.
- [Cohere agreement](https://cohere.com/blog/cohere-and-aleph-alpha-sign-agreement) and [LawZero commitment](https://lawzero.org/en/news/lawzero-receives-commitment-300m-joint-funding-canada-and-germany): use “agreement” and “up to” committed funding; do not describe merger completion or cash receipt. The initial direct opens were intermittent; primary search readback established the wording.
- [Canadian Press police report](https://toronto.citynews.ca/2026/09/16/offices-of-montreal-based-artificial-intelligence-institute-vandalized-one-arrested/) and [COBP callout](https://www.cobp.resist.ca/en/node/25783?page=6) kept separate. No assertion that march organizers committed vandalism, no claim about a completed march, and no unsupported arrest outcome.
- [Futureproof](https://www.futureproof.website/) confirms dates and Vancouver; [post one](https://kriskrug.co/2026/09/15/headed-east-for-all-in-montreal/) provides the series link and voice reference.
- Cordata's public domain did not open reliably, and search surfaced unrelated similarly named products. No guessed URL is inserted. The interview itself supports the attributed product description.
...
|---|---|---|
| Lead / Angelica | `photos/batch-5/21-P68.jpg` | KK and Angelica, September 16; KK self-portrait credit. |
...
Suggested slug: `all-in-montreal-robot-mirror`

Suggested description: `At ALL IN Montréal, Kris Krüg talks robots, civic AI and sovereignty with Angelica Lim, Jeff Ward and the people building between the announcements.`
...
- Repo file-scoped voice gate: 1 file scanned, 0 violations.
- Rendered preview verified in Brave: all 3 images loaded, 23 article links, no horizontal overflow at desktop (1555 px) or narrow viewport (433 px). Mobile layout visually inspected; temporary viewport override reset. All image paths exist and interview hold markers are absent.
- Final draft remains for KK's editorial review. User approval to publish was not requested or inferred.
...
- `post.md` now includes publisher metadata. The article prose is unchanged. `post.html` is the Gutenberg body with captioned photos; `preview.html` remains the local reading proof.
- Used the existing `create_local_wp_draft.py`: offline dry run, authenticated post/page slug-availability check, then create-only `--execute`.
- Media IDs: 12785 (Angelica; featured), 12786 (ProjEx), 12787 (press pen). Prepared JPEGs total approximately 1.1 MB.
...
Image interaction check: the site’s native lightbox controls did not open after clicking both image and expand button in Brave. The final article therefore uses standard media links on all fourteen images, with the native lightbox disabled for these blocks. Each link opens the 2000px web image without a script dependency. The pre-link body is preserved in the rollback directory. The gallery structure, captions and responsive layout are unchanged.
