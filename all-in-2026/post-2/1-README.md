...
Material for Kris's second ALL IN 2026 post (airport -> end of day one). Staged the night of Sep 15, 2026; Kris sorts/edits tomorrow. **Nothing here is published.** Full analysis, captions, transcript notes, and the loose outline live in issue #1023 (documentation/index for this directory).
...
- Berlin Wall sequence (P33-P36) is the light-touch visual echo of the Germany thread (Aleph Alpha/DFKI/Mila - context only, never the spine).
- Batch 1 maps to transcript 1 (ProjEx social, 18:05-19:47 ET) - per-photo mapping in #1023.
- Sep 14 flight-day tapes ("Vancouver Arts Scene" with Milton Lim, "Fragmented Travel") feed the airport/arrival sections; no photos from that leg yet.
...
- Third-party tape content is do-not-repeat until cleared with the speaker.
- Never invent name spellings; use only live-verified ones.
- Outline stays LOOSE - more interviews coming Day 1.
