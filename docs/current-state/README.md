...
**Newest declared snapshot:** [CURRENT-STATE-2026-07-16.md](CURRENT-STATE-2026-07-16.md) — open PRs / issues / WP / Aurora versions are declared there (re-run `make status-readonly` rather than trusting older counts in this index). **Live readback 2026-07-24:** WordPress `7.0.x`, Aurora **`1.4.1`** (Revive cream a11y polish R1–R4 — [REVIVE-AURORA-REVISIONS-2026-07-24.md](REVIVE-AURORA-REVISIONS-2026-07-24.md), deploy [../../backup/aurora-deploy-20260724/DEPLOY-HANDOFF.md](../../backup/aurora-deploy-20260724/DEPLOY-HANDOFF.md), e2e [../../backup/aurora-deploy-20260724/e2e/E2E-REPORT-1.4.1-2026-07-24.md](../../backup/aurora-deploy-20260724/e2e/E2E-REPORT-1.4.1-2026-07-24.md); port contract [REVIVE-AURORA-PORT-2026-07-24.md](REVIVE-AURORA-PORT-2026-07-24.md)).
...
| [CSS-DEADCODE-OVERLAP-AUDIT.md](CSS-DEADCODE-OVERLAP-AUDIT.md) | #256 measured CSS audit feeding the #423 stylesheet rebuild: 101 confidently-dead class selectors (22,788 B / 12.6%), 33 cross-file duplicate selectors, 160 `!important` with the cascade war mapped, 29 KB of `!important`-heavy CSS embedded in page content, and the schema/Code-Snippets duplicate-emission checklist for wp-admin. Reproduce with `scripts/css_coverage_audit.py`. |
