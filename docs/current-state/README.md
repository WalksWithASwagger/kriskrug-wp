...
## Current Front Door (verified 2026-07-02 via live public probes)
...
**Newest Track B addendum:** [HANDOFF-2026-06-17.md](HANDOFF-2026-06-17.md#2026-07-02-aurora-cache--a11y-deploy-checklist-addendum) — production is on Aurora **1.3.33**, canonical Home/About/Blog/Work/Contact pass `pa11y --standard WCAG2AA`, Jetpack Boost is serving fresh bundle `a55f5152ba`, and the deploy checklist now documents the PressCACHE/Boost stale-bundle caveat. Keep [AURORA-READABILITY-RESET-CLOSEOUT-2026-07-01.md](AURORA-READABILITY-RESET-CLOSEOUT-2026-07-01.md) as the previous Track B readability closeout.

**Latest general handoff:** [HANDOFF-2026-06-17.md](HANDOFF-2026-06-17.md) — prod was on Aurora **1.3.18** when first written, then received the 2026-07-02 Aurora **1.3.33** cache/a11y addendum. Content cadence live through 07-02, Storyhive companion **12327 LIVE** (2026-06-17), #207/#208/#220 closed.
...
| [CONTENT-ARCHITECTURE-RESET-2026-07-01.md](CONTENT-ARCHITECTURE-RESET-2026-07-01.md) | Trust + Offers and Topic Hubs content architecture waves: source pack, snapshot-gated live writes, verification, and next content wave. |
...
- **2026-07-02 Aurora cache/a11y addendum:** Production now runs **`kk-aurora` 1.3.33**. Canonical `/`, `/about/`, `/blog/`, `/work/`, and `/contact/` pass `pa11y --standard WCAG2AA`; the temporary a11y fallback snippet is inactive; PressCACHE purge succeeded; and Jetpack Boost now serves fresh bundle `a55f5152ba` on core routes. Keep #125 open for broader Boost/CWV follow-up, but the stale `b822d94c49`/`daddeafb99` cache episode is resolved and watchlisted. See [HANDOFF-2026-06-17.md](HANDOFF-2026-06-17.md#2026-07-02-aurora-cache--a11y-deploy-checklist-addendum).
...
| Draft queue truth | `make status-readonly` or `make draft-queue-audit` | Snapshot values: `2` future posts, `72` draft posts, `5` draft pages. |
