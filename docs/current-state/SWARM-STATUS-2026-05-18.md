...
- The next publishing batch exists locally as three dry-run packs.
...
| Lane 2 - Draft publishing relaunch | Three local dry-run packs created | [`DRAFT-PUBLISHING-DISCOVERY-2026-05-18.md`](DRAFT-PUBLISHING-DISCOVERY-2026-05-18.md) and `content/drafts/2026-05-*` | Editorial cleanup, category mapping, alt-text cleanup, then create WP drafts only |
...
These are ready as local review packs, not ready for one-click publish yet:
...
| 2 | `content/drafts/2026-05-06-comox-valley-ai-is-becoming-its-own-thing/` | 110 blocks, no images | Replace `Draft status...` excerpt/meta; decide whether it needs a featured image |
| 3 | `content/drafts/2026-05-16-why-we-built-the-responsible-ai-professional-certification/` | 83 blocks, 13 images | Replace byline excerpt/meta; review slide-derived alt text |
...
`RESUME-HERE.md` previously pasted a WordPress application password in tracked documentation. It has been redacted in the working tree. Treat that credential as exposed in git history and rotate it before the next live publishing session.
...
| Worker | Scope | Output |
|---|---|---|
| Publisher prep | Three draft packs only | Clean excerpts/meta/alt/category decisions, no WP writes |
