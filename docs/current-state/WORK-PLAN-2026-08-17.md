...
**Last verified:** 2026-08-18 02:19 UTC. Live `style.css` **1.6.8**. Gate 0 content + #706 origin greps live. #826 and #827 applied (cache-busted HTML). #480 `photography.html` recut to keep those links; pack still not applied. **#731 blocked**: Boost is local/free Critical CSS; app password 403s data-sync. Next: KK Regenerates in Jetpack → Boost. Run `make status-readonly` and a public `style.css` readback before acting.
