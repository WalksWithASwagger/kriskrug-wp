...
- Open PRs: `5` (this truth-sync PR + stale Dependabot #394/#396/#397/#398 whose branches were deleted as superseded by #432; close those four in the GitHub UI).
- Open issues: `77`.
...
- Open issues moved ~33 → **42** after Monday + long-run queue filing; open PRs are **5** during truth-sync (close zombie Dependabot #394/#396/#397/#398 in UI); open issues about **77**.
