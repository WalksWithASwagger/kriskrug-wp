...
- Open PRs: `1` (final clearance PR #435).
- Open issues: `77`.
...
- Open issues moved ~33 → **42** after Monday + long-run queue filing; open PRs are **0** after cleanup through #434; open issues about **77**.
