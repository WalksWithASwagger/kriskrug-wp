...
- Open PRs: `0` (stale Dependabot #394/#396/#397/#398 may linger in UI until closed; branches deleted as superseded by #432).
- Open issues: `77`.
...
- Open issues moved ~33 → **42** after Monday + long-run queue filing; open PRs target **0** after Dependabot/docs cleanup (close zombie #394/#396/#397/#398 in UI if still listed); open issues about **77**.
