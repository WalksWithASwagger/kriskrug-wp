...
**Snapshot time:** 2026-07-30 (truth reset after debt/docs/bloat audit). Live counters and versions refreshed 2026-08-12: WordPress `7.0.4`; Aurora live and repo `main` in sync at `1.6.4`.
...
Master sequence: [`MASTER-PLAN-2026-07-30.md`](MASTER-PLAN-2026-07-30.md). Latest dated runbook: [`WORK-PLAN-2026-08-09.md`](WORK-PLAN-2026-08-09.md).
...
- `origin/main` includes Aurora **1.6.4** and the merged Gorgeous Ghost draft package (PR #722).
...
- Live Aurora theme (`style.css` Version header): `1.6.4` (public readback 2026-08-12).
- Repo Aurora theme (`theme/kk-aurora/` on `main`): `1.6.4`. Live and repo are **in sync**.
