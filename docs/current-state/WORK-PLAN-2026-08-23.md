...
|---|---|
| **#738** | Closed; remote, local-branch, worktree, and stash inventories now contain only the clean `main` state. |
| **#749** | Closed 2026-08-28 after the exact pair-safe local prune reclaimed ~906 MiB and passed visual preflight. |
| **#706** | Closed 2026-08-28 after KK accepted the documented delayed-gtag PSI caveat; the fresh eight-route public readback passed. |
