...
**Purpose:** current front door after the diagnostic/polish closeout, backup-gate retirement, draft-quality reset, WordPress 7 readiness prep, and 63-issue queue audit.
**Snapshot time:** 2026-05-22, refreshed after StoryHive review-draft rescue, WP 7 readiness tooling, and queue re-routing.
**Branch:** `main`
...
- 2026-05-22 issue queue audit: open issues are routed in [ISSUE-QUEUE-AUDIT-2026-05-22.md](ISSUE-QUEUE-AUDIT-2026-05-22.md). Use that before closing, re-scoping, or swarming the 63-issue backlog.
...
- Added the 2026-05-22 issue queue audit to route the 63 open issues into close/re-scope, Track A polish, draft publishing, WP 7 readiness, Track B, and parked strategy lanes.
...
### 3. Run issue hygiene from the queue audit

Goal: reduce tracker fog without turning January automation noise into accidental implementation.

Done when:
- `#95` is re-scoped because the strict backup gate is retired and private draft `11879` exists,
- `#3`, `#12`, and `#16` are verified and closed or re-scoped with evidence,
- `#17` and `#68` are consolidated around the current Work page target,
