...
**Last verified:** 2026-07-19 cleanup pass (live WP **7.0.2**, Aurora live **1.3.37** / repo **1.3.40**, declared defaults synced to 7.0.2; Cloud secrets may still be unset in long-lived pods). If you're reading this much later and the repo has drifted, run `make morning-truth` (or `make status-readonly`) and treat the newest committed `docs/current-state/reports/morning-truth-*.md` as the source of truth.
