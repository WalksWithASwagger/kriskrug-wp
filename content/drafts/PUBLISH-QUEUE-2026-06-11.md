...
| ~~11~~ | How We Did It: Behind the Scenes of the SFU SIAT Microcredential Project | `2026-05-24-how-we-did-it-behind-the-scenes-of-the-sfu-siat-microcredential-project` | 🔒 **WITHDRAWN — CONFIDENTIAL, do not publish/share** (KK 2026-06-14). WP `12038` stays an unpublished `draft`; removed from queue permanently. Not an image problem. | n/a — do not publish. |
