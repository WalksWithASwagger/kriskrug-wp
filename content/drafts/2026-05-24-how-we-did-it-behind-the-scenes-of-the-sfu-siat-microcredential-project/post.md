---
title: 'How We Did It: Behind the Scenes of the SFU SIAT Microcredential Project'
...
**The knowledge is the asset, not the platform.** The transcripts, interviews, and content outlive any one tech stack.**Authentic voices build trust faster than ads.** People can spot committee-speak from a mile away.**Networks multiply reach through trust.** A newsletter from a respected partner beats ten thousand cold impressions.**Systems compound, campaigns expire.** Every cohort, every email, every partnership makes the next round easier and more effective[[1]](https://walkswithaswagger.github.io/metacreation-marketing/case-studies/sfu-siat-ava-methodology.html).

## Drill Goals: What We Were Really Trying to Do
