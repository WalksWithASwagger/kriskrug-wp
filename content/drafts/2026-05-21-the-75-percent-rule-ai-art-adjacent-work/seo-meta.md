...
| Field | Value |
|---|---|
| Visible title (H1) | The 75% Rule: Automate The Art-Adjacent, Protect The Art |
| SEO title (`<title>`) | The 75% Rule: AI For Artists \| Kris Krug |
| Slug | `the-75-percent-rule-ai-art-adjacent-work` |
| Meta description | A practical AI rule for artists and creative pros: automate the art-adjacent work first, protect the human craft, and keep documentary truth intact. |
