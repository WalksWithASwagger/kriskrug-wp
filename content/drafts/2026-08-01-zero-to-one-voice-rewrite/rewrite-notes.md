...
**2026-08-16 addendum:** membership figures in `proposed-content-raw.html` /
`rewritten-body.md` were recast to **$340/year** and **300 members** (KK ruling
on #615). Passages in this file that still quote 130 / $240 as preserved are
historical notes from the 2026-08-01 pass. Current payload truth is
`before-after.md` and `README.md`.
